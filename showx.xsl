...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">
    ...
    function informace() {
     ...
     function callexcel(){
    // p�evod po jednotliv�ch ��dk�ch vcetne zahlavi
     var x=tbl.rows;
      try{
        var oXL = new ActiveXObject("Excel.Application");
                ...
                "\n - na po��ta�i nen� nainstalov�n Excel "+
                "\n - zabezpe�en� IE zakazuje spou�t�t ActiveX prvky ");
                return
                } 
      oXL.Visible = true;
   ...
   function callopenoffice() {
	...
	{alert("Ne, nelze spustit Open Office :: " + e.description + "\n Na tomto po��ta�i nen� z�ejm� nainstalov�n Open Office!!");
	return
	} 
 ...
 { 
      ...
      <TABLE ID="main" BORDER="0" CELLSPACING="0" CELLPADDING="0" ALIGN="center" WIDTH="95%">
        ...
        <TR>
          <TD class="noprint" style="text-align:left">
            <A title="Zp�t ">
              <xsl:attribute name="HREF">javascript:zpet();</xsl:attribute>&#8656;&#160;Zp�t</A>
  ...
  <xsl:template match="MESDAT">
    <TD align="center">
      <text>m�s�c</text>:      <xsl:value-of select="."/>
 . </TD>
  </xsl:template>

  <xsl:template match="SESTAVAN">
    <TD align="center">
      <text>�.sestavy</text>:      <xsl:value-of select="."/>
. </TD>
  </xsl:template>
    ...
    <div class="tableContainer">
      <TABLE id="tbl">
        ...
        <TFOOT>
          <TR class="zapati">
            <TD class="zapati">
              <A class="noprint" title="Informace o sestav�" href="javascript:informace();">?</A>
            </TD>
            <TD class="zapati">
